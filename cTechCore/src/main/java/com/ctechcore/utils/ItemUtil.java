...
public class ItemUtil {
  ...
  public static ItemStack makeItemUnbreakable(Material material) {
    return makeItemUnbreakable(new ItemStack(material));
  }
  ...
  public static ItemStack createUnbreakableItem(Material material, String title, List<String> description) {
    ...
    ItemMeta meta = item.getItemMeta();
    item.setItemMeta(meta);
    return makeItemUnbreakable(item);
  }
